...
import br.ufcg.ppgcc.compor.jcf.experimento.fachada.Relatorio;
...
public class Experimento1Test {
	...
	@Test
	public void doisTiulares() {
		Titular titular1 = criarTitularPadrao();
		fachada.criarTitular(titular1);
		Titular titular2 = criarTitularMinimo();
		fachada.criarTitular(titular2);
	...
	@Test
	public void duasFontesPagadorasParaUmTitular() {
		Titular titular = criarTitularPadrao();
		fachada.criarTitular(titular);
	...
	@Test
	public void duasFontesPagadorasUmaParaCadaTitular() {
		Titular titular1 = criarTitularPadrao();
		fachada.criarTitular(titular1);
		FontePagadora fonte1 = criarFontePagadoraPadrao1();
	...
	@Test
	public void doisDependentesParaUmTitular() {
		Titular titular = criarTitularPadrao();
		fachada.criarTitular(titular);
	...
	@Test
	public void doisDependentesUmParaCadaTitular() {
		Titular titular1 = criarTitularPadrao();
		fachada.criarTitular(titular1);
		Dependente dependente1 = criarDependentePadrao1();
	...
	public void calculoImpostoIsento_1() {
		...
		Relatorio completo = fachada.relatorioCompleto(titular);
	...
	public void calculoImpostoFaixa4ComDependente() {
		FontePagadora fonte = criarFontePagadoraPorRenda(50000);
		Titular titular = salvarTitularComUmaFonte(fonte);
		Pessoa dependente1 = criarDependentePadrao1();
		fachada.criarDependente(titular, dependente1);
	...
	public void titularComCpfInvalido2() {
		Titular declaracao = new Titular();
		declaracao.setCpf("abc"); 
		fachada.criarTitular(declaracao);
	}
	...
	public void calculoImpostoSimplificadoFaixa4DeducaoSaudeDependente() {
		...
		Relatorio simplificado = fachada.relatorioSimplificado(titular);
